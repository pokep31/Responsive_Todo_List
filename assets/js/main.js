...
const inputField = document.querySelector(".input-field textarea"),
      ...
      function allTasks() {
        ...
        //if tasks.length is 0, the pending num text content will be "no", if not, pending num value will be task's length.
...
//deleting tasks when we click on the delete icon.
